...
│   └── EnhancedFutureValueApp/
│       └── LocascioEnhancedFutureValueApp.class
│
└── .vscode/
    ├── settings.json
    └── launch.json
...
From the project root (`EnhancedFutureValueApp/`), compile the source files into the `bin/` directory:
`javac -d bin --module-path "C:/Program Files/Java/javafx-sdk-17.0.19/lib" --add-modules javafx.controls,javafx.fxml src/EnhancedFutureValueApp/*.java`
...
`java --module-path "C:/Program Files/Java/javafx-sdk-17.0.19/lib" --add-modules javafx.controls,javafx.fxml -cp bin EnhancedFutureValueApp.LocascioEnhancedFutureValueApp`
...
2. Open `LocascioEnhancedFutureValueApp.java`  
...
`jar --create --file LocascioEnhancedFutureValueApp.jar --main-class EnhancedFutureValueApp.LocascioEnhancedFutureValueApp -C bin/ .`

### Run the JAR
`java --module-path "C:/Program Files/Java/javafx-sdk-17.0.19/lib" --add-modules javafx.controls,javafx.fxml -jar EnhancedFutureValueApp.jar`
